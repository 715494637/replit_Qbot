...
if [ ! -f ./Miao-Yunzai/plugins/chatgpt-plugin/config/config.json ]; then
    wget -O ./Miao-Yunzai/plugins/chatgpt-plugin/config/config.json https://github.com/715494637/replit_Qbot/blob/main/chatgpt/config.json
fi
if [ ! -f ./Miao-Yunzai/plugins/guoba-plugin/config/application.yaml ]; then
    wget -O ./Miao-Yunzai/plugins/guoba-plugin/config/application.yaml https://github.com/715494637/replit_Qbot/blob/main/gupoba/application.yaml
fi
